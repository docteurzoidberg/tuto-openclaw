...
- [x] [Étape 8 — Cas d'usage : notes, rappels (cron), todolists](etapes/etape-08-usages.md)
- [x] [Étape 9 — Créer un skill custom (todolist Markdown)](etapes/etape-09-skill-custom.md)
